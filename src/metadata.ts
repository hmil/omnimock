...
export type GetMetadata<Key extends string, T extends WithMetadata<Key, any>> =
        T extends WithMetadata<Key, infer DATA> ? DATA : never;
...
export function setMetadata<Key extends string, DATA, T extends WithMetadata<Key, DATA>>(
        target: T,
        key: Key,
        metadata: DATA): T {
